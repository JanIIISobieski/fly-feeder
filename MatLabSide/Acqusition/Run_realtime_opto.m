function [is,insta,zone,d,Centroid] = Run_realtime_opto(frame, thresh, is, ...
                                                        bkg, zone, blobAnalyser, ...
                                                        d, Centroid, obsvWindow, ...
                                                        FPS, daMask)
    global i
    ...
    [insta.Area,insta.Centroid,insta.Orientation] = step(blobAnalyser, ...
                                                         or(frame_bi,daMask.Outside));
    ...
    if length(insta.Orientation) == 1  % only 1 blob seen
        ...
        insta.speed = norm(insta.velocity);  %speed is magnitude of velocity vector
